...
// Middleware
app.use(cors({ origin: 'http://localhost:3000', methods: 'GET,HEAD,PUT,PATCH,POST,DELETE', credentials: true }));
app.use(express.json()); // No need for body-parser as express has built-in JSON parser
app.use(someMiddleware); // Ensure `someMiddleware` is a function, not an object
...
// Routes
// console.log(typeof productRoutes);  // Should print 'function'
// console.log(typeof cartRoutes);     // Should print 'function'
